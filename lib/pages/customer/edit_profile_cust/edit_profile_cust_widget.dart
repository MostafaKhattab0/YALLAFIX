...
import 'edit_profile_cust_model.dart';
export 'edit_profile_cust_model.dart';

class EditProfileCustWidget extends StatefulWidget {
  const EditProfileCustWidget({super.key});

  @override
  State<EditProfileCustWidget> createState() => _EditProfileCustWidgetState();
}

class _EditProfileCustWidgetState extends State<EditProfileCustWidget> {
  late EditProfileCustModel _model;
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'g0sxb7if' /* Please fill out the form below... */,
                ),
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FlutterFlowDropDown<String>(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'sfqxa3z6' /* Choose brand.. */,
                          ),
                          searchHintText: FFLocalizations.of(context).getText(
                            'zi9tle1j' /* Search for a brand... */,
                          ),
                          icon: Icon(
