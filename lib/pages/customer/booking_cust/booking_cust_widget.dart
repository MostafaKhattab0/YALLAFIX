  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RequestsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RequestsRecord> bookingCustRequestsRecordList = snapshot.data!;
        final bookingCustRequestsRecord =
            bookingCustRequestsRecordList.isNotEmpty
                ? bookingCustRequestsRecordList.first
                : null;
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'bdes8upr' /* Please enter yout car issue */,
                                ),
