...
import 'edit_booking_cust_model.dart';
export 'edit_booking_cust_model.dart';

class EditBookingCustWidget extends StatefulWidget {
  const EditBookingCustWidget({
    super.key,
    required this.req,
  });
  ...
  @override
  State<EditBookingCustWidget> createState() => _EditBookingCustWidgetState();
}

class _EditBookingCustWidgetState extends State<EditBookingCustWidget> {
  late EditBookingCustModel _model;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RequestsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RequestsRecord> editBookingCustRequestsRecordList = snapshot.data!;
        final editBookingCustRequestsRecord =
            editBookingCustRequestsRecordList.isNotEmpty
                ? editBookingCustRequestsRecordList.first
                : null;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            StreamBuilder<List<ServicesRecord>>(
                              stream: queryServicesRecord(
                                queryBuilder: (servicesRecord) =>
                                    servicesRecord.orderBy('service_id'),
                              ),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                            ...
                            FlutterFlowIconButton(
                              ...
                              borderWidth: 1.0,
                              buttonSize: 40.0,
                              fillColor: const Color(0xFF2851C8),
                              icon: Icon(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.req!.reference.update({
                            ...
                            ...mapToFirestore(
                              {
                                'request_services': _model.dropDownValue,
                              },
                            ),
                          });
