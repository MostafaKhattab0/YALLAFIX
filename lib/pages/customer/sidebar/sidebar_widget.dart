...
class _SidebarWidgetState extends State<SidebarWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SIDEBAR_COMP_sidebar_ON_INIT_STATE');
      if (() {
      ...
      child: Padding(
        ...
        child: AuthUserStreamWidget(
          builder: (context) => StreamBuilder<CustomersRecord>(
            stream:
                CustomersRecord.getDocument(currentUserDocument!.customerRef!),
                            ...
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl: valueOrDefault<String>(
                                  columnCustomersRecord.customerImage,
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SIDEBAR_COMP_Row_i8j5u8cg_ON_TAP');
                                  logFirebaseEvent('Row_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                                  await authManager.signOut();
                                  GoRouter.of(context).clearRedirectLocation();
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SIDEBAR_COMP_Icon_n2bw3lmf_ON_TAP');
