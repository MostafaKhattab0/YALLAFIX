...
import 'add_center_model.dart';
export 'add_center_model.dart';
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  '572pwvno' /* Please fill in the information... */,
                ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.centerNameTextController,
                                    focusNode: _model.centerNameFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.centerNameFocusNode
                                                  ?.hasFocus ??
                                              false)
                                  ...
                                  StreamBuilder<List<BrandsRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'wgcyrhyz' /* Please select... */,
                                        ),
                                        searchHintText:
                                            FFLocalizations.of(context).getText(
                                          '7d7baluj' /* Search for an item... */,
                                        ),
                                        icon: Icon(
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.centerDescriptionFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await CentersRecord.collection
                                              .doc()
                                              .set({
                                            ...createCentersRecordData(
                                              centerName:
                                                  valueOrDefault<String>(
                                                _model.centerNameTextController
                                                    .text,
                                                'x',
                                              ),
