...
import 'profile_advisor_model.dart';
export 'profile_advisor_model.dart';

class ProfileAdvisorWidget extends StatefulWidget {
  const ProfileAdvisorWidget({super.key});

  @override
  State<ProfileAdvisorWidget> createState() => _ProfileAdvisorWidgetState();
}

class _ProfileAdvisorWidgetState extends State<ProfileAdvisorWidget>
    with TickerProviderStateMixin {
  late ProfileAdvisorModel _model;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'fns2b4gy' /* andrea@domainname.com */,
                  ),
